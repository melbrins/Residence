...
<link rel="stylesheet" type="text/css" href="css/residence_style.css" />

<!-- <link href='http://fonts.googleapis.com/css?family=Bad+Script' rel='stylesheet' type='text/css' /> -->

      

<script type="text/javascript" src="http://www.residenceestates.com/js/jquery.min.js"></script>
...
?>
		...
		<div class="property_text">
			...
			<?php if($donnees['Short'] != null){?><p class="short_desc"><?php echo stripslashes($donnees['Short']);?></p><?php } ?>
			<p class="desc"><?php echo stripslashes($donnees['Description']); ?></p>
...
?>
	...
	?>
					...
					<div id="floor_map" style="float:left;">
						...
						<a href="images/map/<?php echo $donnees['Picture']; ?>" rel="prettyPhoto" title="You can add caption to pictures. You can add caption to pictures. You can add caption to pictures."><img src="images/map/<?php echo $donnees['Picture']; ?>" alt="Floor map <?php echo $donnees['Reference']; ?>" style="height:100%;"/></a>
