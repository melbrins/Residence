...
try
	{
		...
		while ($donnees = $Info->fetch())
		{
            ...
            $daytime = htmlentities($_POST['Daytime']);
            $weektime = htmlentities($_POST['Weektime']);
            $further = htmlentities($_POST['Further']);

			// Variables concernant l'email
			$destinataire = $donnees['Email']; //'melbrins@hotmail.com'; // Adresse email du webmaster (à personnaliser)
			$sujet = 'Arrange a view'; // Titre de l'email
    ...
    <tr>
        <td style="padding:12px 10px 40px;">
                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            ...
                            <tr>
                                <td width="480" style="width:480px; padding:0 0 0 20px;">
                                    ...
                                    <font style="font-size:10px; font-family:arial, helvetica, sans-serif; color:#818285;">'.$title.' '.$firstname.' '.$lastname.' sent you a viewing request</font>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                         ...
                                         <tr>
                                            <td style="padding:0 0 30px 0;">
                                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td style="padding-top:10px; width:180px;">
                                                            <font style="font-size:12px; font-weight:bold; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">During the day:</font>
                                                        </td>
                                                        <td style="padding-top:10px;">
                                                            <font style="font-size:12px; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">'.nl2br($daytime).'</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding-top:10px; width:180px;">
                                                            <font style="font-size:12px; font-weight:bold; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">During the week:</font>
                                                        </td>
                                                        <td style="padding-top:10px;">
                                                            <font style="font-size:12px; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">'.nl2br($weektime).'</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding-top:10px; width:180px;">
                                                    ...
                                                    <tr>
                                                        <td style="padding-top:10px; width:180px;">
                                                            <font style="font-size:12px; font-weight:bold; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">Your Property Reference:</font>
                                                        </td>
                                                        <td style="padding-top:10px;">
                                                            <font style="font-size:12px; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">'.$reference.'</font>
                                                        </td>
                                                    </tr>
                                        ...
                                        <tr>
                                            <td colspan="2" style="padding:20px 0 30px 0;">
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td width="200" style="width:200px; padding:0 20px 0 0;">
                                                            <img src="http://www.residenceestates.com/images/'.$image.'" alt="property picture" width="200" aling="top"/>
                                                        </td>
                                                        <td style="vertical-align:top;">
                                                            <font style="font-size:18px; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#552F01;">'.$street.', '.$area.' '.$postcode.'</font>
                                                            <br>
                                                            <br>
                                                            <font style="font-size:14px; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#EF7F00;">£'.$price.' '.$priceper.'</font>
                                                            <br>
                                                            <br>
                                                            <font style="font-size:12px; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">
                                                                '.$bedroom.' bedroom(s) '.$style.' to '.$page.' <br/>
                                                               
                                                            </font>
                                                            <br/>
                                                            <a href="http://www.residenceestates.com/property.php?properties='.page.'&reference='.$reference.'" target="_blank"><img src="http://www.melbrins.com/residence/cms/email/images/btn_view.jpg" width="170" height="25"/></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
		    ...
		    if($sent){  
                ...
                header("Location:../../arrange-view.php?properties=".$page."&reference=".$reference."&sent=success"); 
		    }else{  
