...
try
	{
		...
		while ($donnees = $Info->fetch())
		{
			...
			$sujet = 'Design Studio'; // Titre de l'email
                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            ...
                            <tr>
                                <td width="480" style="width:480px; padding:0 0 0 20px;">
                                    ...
                                    <font style="font-size:10px; font-family:arial, helvetica, sans-serif; color:#818285;">'.$title.' '.$firstname.' '.$lastname.' sent you a design request</font>
                                                ...
                                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    <tr>
                                                        <td style="width:180px;">
                                                            <font style="font-size:12px; font-weight:bold; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">About Your Home:</font>
                                                        </td>
                                                        <td>
                                                            <font style="font-size:12px; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">'.nl2br($home).'</font>
                                                        </td>
                                                    </tr>

                                                    <tr>
                                                        <td style="padding-top:10px; width:180px;">
                                                            <font style="font-size:12px; font-weight:bold; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">Hope To Achieve:</font>
                                                        </td>
                                                        <td style="padding-top:10px;">
                                                            <font style="font-size:12px; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">'.nl2br($hope).'</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding-top:10px; width:180px;">
                                                            <font style="font-size:12px; font-weight:bold; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">Describe Your Style:</font>
                                                        </td>
                                                        <td style="padding-top:10px;">
                                                            <font style="font-size:12px; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">'.nl2br($style).'</font>
                                                        </td>
                                                    </tr>
                                                    
                                                    <tr>
                                                        <td style="padding-top:10px; width:180px;">
                                                            <font style="font-size:12px; font-weight:bold; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">Information Or Queries:</font>
                                                        </td>

                                                        <td style="padding-top:10px;">
                                                            <font style="font-size:12px; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">'.nl2br($other).'</font>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
...
';
		    ...
		    if($sent){  
                ...
                header("Location:../../design.php?sent=success#your-details");  
		    }else{  
		        echo 'failed';// ... or this one to tell it that it wasn't sent  
                header("Location:../../design.php?sent=fail#your-details"); 
		    }
