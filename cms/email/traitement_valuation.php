...
try
	{
		...
		while ($donnees = $Info->fetch())
		{
            ...
            $lastname = htmlentities($_POST['lastname']); // htmlentities() convertit des caractères "spéciaux" en équivalent HTML
            $email = htmlentities($_POST['email']);
            $phone = htmlentities($_POST['phone']);
            $area_client = htmlentities($_POST['area_client']);
            $address_client = htmlentities($_POST['address_client']);
            $postcode_client = htmlentities($_POST['postcode_client']);

            $type = $_POST['type'];
            $value = $_POST['value'];
            $area_value = htmlentities($_POST['area_value']);
            $address_value = htmlentities($_POST['address_value']);
            $postcode_value = htmlentities($_POST['postcode_value']);
            $further = htmlentities($_POST['Further']);

			// Variables concernant l'email
			$destinataire = $donnees['Email']; //'melbrins@gmail.com'; // Adresse email du webmaster (à personnaliser)
			$sujet = 'Valuation'; // Titre de l'email
                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            ...
                            <tr>
                                <td width="480" style="width:480px; padding:0 0 0 20px;">
                                    ...
                                    <font style="font-size:10px; font-family:arial, helvetica, sans-serif; color:#818285;">'.$title.' '.$firstname.' '.$lastname.' sent you a valuation request</font>
                                            ...
                                            <td style="padding:0 0 30px 0;">
                                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding-top:10px;">
                                                            <font style="font-size:12px; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">'.nl2br($area_client).'</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding-top:10px; width:180px;">
                                                        ...
                                                        <td style="padding-top:10px;">
                                                            <font style="font-size:12px; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">'.nl2br($address_client).'</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding-top:10px; width:180px;">
                                                        ...
                                                        <td style="padding-top:10px;">
                                                            <font style="font-size:12px; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">'.nl2br($postcode_client).'</font>
                                                        </td>
                                                    </tr>
                                            ...
                                            <td>
                                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <font style="font-size:12px; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">'.$type.'</font>
                                                        </td>
                                                    </tr>

                                                    <tr>
                                                        <td style="padding-top:10px; width:180px;">
                                                            <font style="font-size:12px; font-weight:bold; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">Value:</font>
                                                        </td>
                                                        <td style="padding-top:10px;">
                                                            <font style="font-size:12px; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">'.$value.'</font>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding-top:10px;">
                                                            <font style="font-size:12px; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">'.$area_value.'</font>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding-top:10px;">
                                                            <font style="font-size:12px; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">'.nl2br($address_value).'</font>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding-top:10px;">
                                                            <font style="font-size:12px; font-family: Arial, Helvetica, sans-serif; line-height:16px; color:#404041;">'.$postcode_value.'</font>
                                                        </td>
                                                    </tr>
...
';
		    ...
		    if($sent){  
                ...
                header("Location:../../valuation.php?sent=success#your-details");   
		    }else{  
		        echo 'failed';// ... or this one to tell it that it wasn't sent  
                header("Location:../../valuation.php?sent=fail#your-details");   
		    }
